...
public class TextSticker extends Sticker {
    ...
    public void draw(@NonNull Canvas canvas) {
        ...
        paint.setARGB(255, Color.red(backgroundColor), Color.green(backgroundColor), Color.blue(backgroundColor));
        canvas.drawRoundRect(0, 0, textRect.width(), textRect.height(), 0, 0, paint);
        canvas.concat(matrix);
